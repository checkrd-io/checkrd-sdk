...
| Report a security vulnerability | [Private advisory](https://github.com/checkrd-io/checkrd-sdk/security/advisories/new). Do **not** open a public issue. See [SECURITY.md](../SECURITY.md). |
| Get commercial support, SLA, or self-host help | [hello@checkrd.io](mailto:hello@checkrd.io) |

For anything ambiguous, the bug-report template is a fine default — we'll redirect you if there's a better venue.
