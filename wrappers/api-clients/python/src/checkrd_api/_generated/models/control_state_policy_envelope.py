...
T = TypeVar("T", bound="ControlStatePolicyEnvelope")


@_attrs_define
class ControlStatePolicyEnvelope:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        control_state_policy_envelope = cls()

        control_state_policy_envelope.additional_properties = d
        return control_state_policy_envelope
