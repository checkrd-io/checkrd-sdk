...
T = TypeVar("T", bound="ControlInitPricingEnvelope")


@_attrs_define
class ControlInitPricingEnvelope:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        control_init_pricing_envelope = cls()

        control_init_pricing_envelope.additional_properties = d
        return control_init_pricing_envelope
