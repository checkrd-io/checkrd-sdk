...
if TYPE_CHECKING:
    from ..models.test_policy_request_tests_type_0_item import TestPolicyRequestTestsType0Item


T = TypeVar("T", bound="TestPolicyRequest")
...
class TestPolicyRequest:
    ...
    `yaml_content`.
        ...
        Attributes:
            ...
            tests (list[TestPolicyRequestTestsType0Item] | None | Unset): Optional explicit test cases. When omitted, the
                server extracts
    ...
    yaml_content: str
    tests: list[TestPolicyRequestTestsType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tests(data: object) -> list[TestPolicyRequestTestsType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for tests_type_0_item_data in _tests_type_0:
                    tests_type_0_item = TestPolicyRequestTestsType0Item.from_dict(tests_type_0_item_data)
                ...
                pass
            return cast(list[TestPolicyRequestTestsType0Item] | None | Unset, data)

        tests = _parse_tests(d.pop("tests", UNSET))

        test_policy_request = cls(
            yaml_content=yaml_content,
            tests=tests,
        )

        test_policy_request.additional_properties = d
        return test_policy_request
