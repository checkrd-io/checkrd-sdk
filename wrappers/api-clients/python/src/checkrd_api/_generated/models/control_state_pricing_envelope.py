...
T = TypeVar("T", bound="ControlStatePricingEnvelope")


@_attrs_define
class ControlStatePricingEnvelope:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        control_state_pricing_envelope = cls()

        control_state_pricing_envelope.additional_properties = d
        return control_state_pricing_envelope
