...
- Package author email consolidated to `support@checkrd.io` (was
  `hello@checkrd.dev` through 0.3.0; 0.3.1 carried the wrong-domain
  fix `hello@checkrd.io`). No SDK behaviour changes; metadata-only.
